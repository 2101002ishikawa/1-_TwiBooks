...
<body>
    ...
    <div class="row">
       ...
       <h3 class="mt-5"><?php=$bookname?></h3>   <!-- 本の名前  -->
       <?php=$bookwriter?>  <!-- 本の著者 -->
        <?php echo "<img src=$bookimage>"?> <!-- 本の画像 -->
        <br>
        <input type="number" name="kosuu" class="mb-3 btn">
        <form action="ここに遷移する場所" method="post">
        <h4><?php=$bookkakaku?></h4>
        <input type="button" name="cart" value="カートに入れる" class="mb-3 btn">
        <br>
        <input type="submit" name="buynow" value="今すぐ購入" class="mb-3 btn">
    </form>
     </div>
